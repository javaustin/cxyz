...
import com.carrotguy69.cxyz.classes.http.Requests.RequestResult;
...
public class Message {
    ...
    public CompletableFuture<RequestResult> submit() {
        return Requests.postRequest(api_endpoint + "/message/submit", gson.toJson(this));
    }
