package com.carrotguy69.cxyz.classes.models.config.channel.channelTypes;
...
public class CustomChannel extends BaseChannel {
    ...
    public void onChat(AsyncPlayerChatEvent e) {
        Logger.log("called CustomChannel.onChat(...)");
        ...
        commonMap.put("content", ChatColor.stripColor(f(e.getMessage())));
        commonMap.put("message", ChatColor.stripColor(f(e.getMessage())));
    ...
    public void onSelect(NetworkPlayer np) {
        Logger.log("called CustomChannel.onSelect(...)");
