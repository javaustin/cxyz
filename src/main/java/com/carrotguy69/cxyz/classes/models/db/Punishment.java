...
public class Punishment {
    ...
    public void create() {
        ...
        Requests.postRequest(api_endpoint + "/punishment/set", gson.toJson(body));
    }
    ...
    public void edit() {
        ...
        Requests.postRequest(api_endpoint + "/punishment/edit", gson.toJson(body));
    }

    public void delete() {
        punishmentIDMap.remove(this.getID(), this);

        Requests.postRequest(api_endpoint + "/punishment/delete", gson.toJson(Map.of("id", this.id)));
    }

    // Static methods
    public static Punishment getLastGlobalPunishment() {
        List<Long> keySet = new ArrayList<>(punishmentIDMap.keySet());
        ...
        return punishmentIDMap.get(keySet.getFirst());
    }
