...
public class Party {
    ...
    public void sync() {
        ...
        Requests.postRequest(api_endpoint + "/party/sync", gson.toJson(Map.of("sender_uuid", this.ownerUUID, "players", this.players, "public", this.public_)));

        
    }

    public void create() {
        Requests.postRequest(api_endpoint + "/party/create", gson.toJson(Map.of("sender_uuid", this.ownerUUID, "players", this.players, "public", this.public_)));
    }
    ...
    public void delete() {
        ...
        Requests.postRequest(api_endpoint + "/party/delete", gson.toJson(Map.of("sender_uuid", this.ownerUUID)));
