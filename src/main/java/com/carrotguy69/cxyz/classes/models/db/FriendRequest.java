...
public class FriendRequest {
    ...
    public void delete() {
        Requests.postRequest(api_endpoint + "/friendRequest/delete", gson.toJson(Map.of("sender", sender, "recipient", recipient, "expireTimestamp", expireTimestamp)));
    }

    public void create() {
        Requests.postRequest(api_endpoint + "/friendRequest/create", gson.toJson(Map.of("sender", sender, "recipient", recipient, "expireTimestamp", expireTimestamp)));
    }

//    public void sync() {
//        Requests.postRequest(api_endpoint + "/friendRequest/sync", gson.toJson(Map.of("inviter", inviter, "recipient", recipient, "expireTimestamp", expireTimestamp)));
//    }
