...
public enum MessageKey {
    ...
    CHAT_CHANNEL_LIST_UNIGNORED("commands.chat-channel.list.unignored"),
    ...
    CHAT_COLOR_INVALID_COLOR("commands.chat-color.invalid-color"),
    ...
    // Commands - Discord
    // =========================
    DISCORD_MESSAGE("commands.discord.message"),
    ...
    FRIEND_LIST("commands.friend.list.format"),
    ...
    PARTY_ERROR_INVITE_EXPIRED("commands.party.error.invite-expired"),
    ...
    PUNISHMENT_AVAILABLE_SUBCOMMANDS("command.punishment.available-subcommands"),
    PUNISHMENT_EDIT("command.punishment.edit"),
    PUNISHMENT_DELETE("command.punishment.delete"),
    ...
    PUNISHMENT_HISTORY_SEPARATOR("commands.punishment.history.delimiter"),
    ...
    RANK_SET("commands.rank.set"),
    RANK_VIEW("commands.rank.view"),
    RANK_LIST("commands.rank.list"),
    RANK_RANK_FORMAT("commands.rank.rank-format"),
    RANK_RANK_SEPARATOR("commands.rank.rank-separator"),
