...
public class ChannelLock implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        */
        ...
        if (!channel.isLockable()) {
            MessageUtils.sendParsedMessage(sender, MessageKey.CHAT_CHANNEL_LOCK_FORBIDDEN, commonMap);
            return true;
        }

        if (channel.isLocked()) {
            MessageUtils.sendParsedMessage(sender, MessageKey.CHAT_CHANNEL_ALREADY_LOCKED, commonMap);
            return true;
        }
        ...
        channel.sendChannelMessage(MessageGrabber.grab(MessageKey.CHAT_CHANNEL_LOCKED), commonMap);
