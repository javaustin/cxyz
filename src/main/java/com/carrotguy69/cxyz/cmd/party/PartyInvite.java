...
public class PartyInvite implements CommandExecutor {
    ...
    public void invite(NetworkPlayer inviter, String recipientName) {
        ...
        recipient.sendMessage(MessageGrabber.grab(MessageKey.PARTY_INVITE_RECEIVED), commonMap); // Sends the party invite message cross-server (if necessary.)
