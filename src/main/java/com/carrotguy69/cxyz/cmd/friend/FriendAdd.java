...
public class FriendAdd implements CommandExecutor {
    ...
    public void sendFriendRequest(NetworkPlayer sender, String recipientName) {
        ...
        recipient.sendMessage(MessageGrabber.grab(MessageKey.FRIEND_REQUEST_RECEIVED), commonMap); // Sends the friend request message cross-server (if necessary.)
