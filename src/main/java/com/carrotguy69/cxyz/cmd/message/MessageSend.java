package com.carrotguy69.cxyz.cmd.message;
...
public class MessageSend implements CommandExecutor {
    ...
    public static void sendMessage(NetworkPlayer sender, String targetName, String content, boolean reply) {
        ...
        if (content != null) {
            ...
            sender.sendMessage(MessageGrabber.grab(MessageKey.MESSAGE_SENT), commonMap);
            recipient.sendMessage(MessageGrabber.grab(MessageKey.MESSAGE_RECEIVED), commonMap);
        }
            ...
            sender.sendMessage(MessageGrabber.grab(MessageKey.MESSAGE_OPENED), commonMap);
