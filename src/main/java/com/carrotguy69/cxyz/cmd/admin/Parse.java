...
import com.carrotguy69.cxyz.other.messages.MessageParser;
...
public class Parse implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String s, @NotNull String[] args) {
        ...
        String node = "cxyz.admin.util.parse";
        ...
        try {
            ...
            MessageUtils.sendParsedMessage(sender, MessageKey.PARSE_ERROR, Map.of("error", ex.getDescription(), "text", content));
        }
