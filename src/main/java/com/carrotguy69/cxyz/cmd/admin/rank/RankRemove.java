...
public class RankRemove implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String s, @NotNull String[] args) {
        ...
        /*
        SYNTAX:
            /rank remove <rank> [player]
            /rank remove admin Notch
        */

        String node = "cxyz.admin.rank.remove";
    ...
    private static void removeRank(CommandSender sender, NetworkPlayer np, String rankName) {
        try {
