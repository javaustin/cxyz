package com.carrotguy69.cxyz.cmd.level;
...
public class LevelSet implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String s, @NotNull String[] args) {
        ...
        */
        ...
        //                (-1)    0       1
        // Syntax: /level set {amount} {player}
    ...
    public static void set(CommandSender sender, NetworkPlayer np, int amt) {
        amt = Math.abs(amt);

        np.setLevel(amt);
        np.setXP(_LevelExecutor.levelToXP(amt));
